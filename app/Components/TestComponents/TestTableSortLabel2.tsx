...
function stableSort(array: readonly [], comparator: (a: any, b: any) => number) {   // j'ai enlevé T sinon erreur !!!
...
const headCells: readonly Column[] = [    // const columns: readonly Column[] = [               // readonly ???
  {
...
export default function TestTableSortLabel2({ contacts, selectedContactId, setSelectedContact, handleUpdateContact, handleDeleteContact
  //setContacts
}: ContactsTableProps) {

    // const [contacts, setContacts] = React.useState<Contact[]>(contactsData)
    const rows: any = contacts

//export default function TestTableSortLabel() {
