...
const ContactsTable = ({ contacts, currentUserId, 
    ...
    handleUpdateContact, handleDeleteContact, displayContactCard, getPriorityTextAndColor}: ContactsTableProps) => {

    const [selectedContactId, setSelectedContactId] = React.useState("");

    //console.log("CONTACT TABLE")
    console.log("CONTACT TABLE Contacts = ", contacts)
    console.log("TABLEAU selectedContactId = ", selectedContactId)

    // J'ai utilisé Memo et useCallback pour pas que toute la liste ne se rerende à chaque changement sur un contact mais comme chaque contactId change à chaque fois dans le liste de contact, ça ne foncitonne pas...
                    ...
                    <TableBody>
                        ...
                        {/* {visibleRows.map((row: Contact) => {
                            ...
                            return (
                                ...
                                // Marche pas car row est un objet donc change à chaque fois et créé un rerender
                                <ContactRowMemo
                                    key={row.id}
                                    contact={row}
                                    currentUserId={currentUserId}
