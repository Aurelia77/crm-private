...
export default function ContactForm({
    ...
    const [test, setTest] = React.useState<string>("coucou")

    const TESTgetLogoAndDomainTEST = (businessName: string) => { 

        //console.log(`https://autocomplete.clearbit.com/v1/companies/suggest?query=${businessName}`)
        
        //const [domain, setDomain] = React.useState<string>("")
        //const [logo, setLogo] = React.useState<string>("")
        
        let logo = "LOOOOOOOGOOOOOOOOOO"
        let domain

        fetch(`https://autocomplete.clearbit.com/v1/companies/suggest?query=${businessName}`, {
        //fetch(`https://autocomplete.clearbit.com/v1/companies/suggest?query="Les Trésors de Lily"`, {
            ...
            setTest("coucou222222 "+ businessName )
        ...
        //console.log('000000000000000000000test', test)

        return {logo, domain, test }
    }

    //console.log(TESTgetLogoAndDomainTEST("Les Trésors de Lily"))
    //console.log(TESTgetLogoAndDomainTEST("Les Trésors de Lily").logo)

    
    // React.useEffect(() => {
    //     console.log("!!!!!!!!!!!",TESTgetLogoAndDomainTEST("Les Trésors de Lily"))
    //     let tabNamOfBusiness = ["CPPTE DES VIGNES", "PEPPER GRENOBLE", "AUX TRESORS DE LILY", "LES TRESORS DE LILY"]
    //     tabNamOfBusiness.map((businessName: string) => {
    //         console.log("businessName", businessName)
    //         console.log(TESTgetLogoAndDomainTEST(businessName).logo)
    //         console.log(TESTgetLogoAndDomainTEST(businessName).domain)
    //         console.log(TESTgetLogoAndDomainTEST(businessName).test)
    //         console.log('11111111111111test', test)
    //     })
    // },[])
  
    //console.log('2222222222222222test', test)
    ...
    //         console.log('11111111111111test', test)
    //     },[])
    //     console.log('7777777777777777777test', test)
    ...
    const getLogoAndDomain = (businessName: string) => { 

        console.log("getLogoAndDomain") 
    ...
    //console.log(getLogoAndDomain("Les Trésors de Lily"))
    // console.log(logo)
    // console.log(domaine)


    React.useEffect(() => {
        console.log("***2***-USEEFFECT-1 QUERY : query", query)
    ...
    React.useEffect(() => {
        ...
        resultInseeSearch.forEach((business: any, index: number) => {          
            ...
            //getLogoAndDomain(business.uniteLegale.denominationUniteLegale)      // Pas possible de faire ça ici car le LOGO et DOMAIN sont mis à jour après le RENDER !!! => Donc à faire dans un autre USEEFFECT quand resultInseeSearchToKeep est mis à jour !!!
        ...
        console.log("123123123123tempTab", tempTab)
        //console.log("123123123123tempTabLogoAndDomain", tempTabLogoAndDomain)   // vide

        // const xxx = Object.assign(tempTab, tempTabLogoAndDomain) // ??? Proposition Copilot :  Object.assign({}, tempTab, tempTabLogoAndDomain)
        // console.log("123123123123xxx", xxx)  
    ...
    React.useEffect(() => {
        ...
        console.log("**123resultInseeSearchDomainAndLogo", resultInseeSearchDomainAndLogo)
        console.log("**123resultInseeSearchDomainAndLogoLENGTH", resultInseeSearchDomainAndLogo.length)
    ...
    // React.useEffect(() => {
    //     console.log("!!!!!!***3-222222***-USEEFFECT RESULTINSEE : resultInseeSearch", resultInseeSearch)
    //     console.log("!!!!!!***3-222222***-USEEFFECT RESULTINSEE : resultInseeSearch", resultInseeSearchToKeep)

    //     let tempTab2 : any[] = []   //////// A CHANGER ???

    //     // resultInseeSearchToKeep.map((business: any, index: number) => {

    //     //     //getLogoAndDomain(business.uniteLegale.denominationUniteLegale)      // Pas possible de faire ça ici car le LOGO et DOMAIN sont mis à jour après le RENDER !!! => Donc à faire dans un autre USEEFFECT quand resultInseeSearchToKeep est mis à jour !!!

    //     //     //TESTgetLogoAndDomainTEST(business.uniteLegale.denominationUniteLegale)   
    //     //     //console.log(TESTgetLogoAndDomainTEST(business.uniteLegale.denominationUniteLegale)[0].logo)  
    ...
    //     //         //denominationUsuelleEtablissement
    //     //  })
    //     // setResultInseeSearchToKeep(tempTab2)
    ...
    // React.useEffect(() => {
    //     setResultInseeSearchToKeepPlusDomainAndLogo(
    //         resultInseeSearchToKeep.map((contact: Contact) => {

    //             return {...contact, logo: logo, businessWebsite: domaine}
    //         })
    //     )
    // },[resultInseeSearchToKeep])
