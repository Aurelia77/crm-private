...
import ContactsTable4 from '@/app/Components/contactsManager/ContactsTable4';
...
export default function ContactsTablePage() {
  ...
  const updateContactInContactsAndDB = contactsContextValue.updateContactInContactsAndDB
